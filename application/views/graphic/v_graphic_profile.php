...
<div id="content">
    <div class="content_wrapper">
        ...
        <div class="container">
            ...
            <h1>
                profile
                <?php echo anchor('c_graphic/index', '<-go back', array('class' => 'text_light smaller pp_dark_gray red_on_hover inunderlined upper_cased')); ?>                 
            </h1>
            <div class="blue_line">
            </div>  
            ...
            echo form_open("c_graphic/edit_profile", $attributes);
            ?>            
